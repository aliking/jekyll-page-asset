...
layout: page
title: Home
description: Page asset plugin demo site
---

The `page_asset` plugin designed for a project portfolio style ( although it might well work with blog/post style layouts)
